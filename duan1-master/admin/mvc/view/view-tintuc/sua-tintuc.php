                ...
                <div class="card card-body">
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                            <label>Tiêu đề</label>
                            <input type="text" name="title" value="<?php echo $data["Title"] ?>" class="form-control" required placeholder="Nhập tiêu đề">
                        </div>
                        <img width="300px" src="../mvc/Webroot/image/img_news/<?php echo $data['Images'] ?>" alt=""><br><br>
                        <div class="form-group">
                            <label>Ảnh tin</label>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="detail" class="form-control" id="fff" rows="3"><?php echo $data["Content"] ?></textarea>
                        </div>
                        <script>

    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="page-title">Thêm imfomation</h4>
                <div class="m-icon">
                ...
                <div class="d-flex align-items-center justify-content-end">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href="">Thêm imfomation</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="card card-body">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="logotext" required="" class="form-control" placeholder="Nhập tên logo">
                        </div>
                        <div class="form-group">
                            <label>Địa chỉ</label>
                            <input type="text" name="address" required="" class="form-control" placeholder="Nhập địa chỉ">
                        </div>
                        <div class="form-group">
                            <label>Email</label>
                            <input type="text" name="email" required="" class="form-control" placeholder="Nhập email">
                        </div>
                        <div class="form-group">
                            <label>Hotline</label>
                            <input type="number" name="phone" required="" class="form-control" min="0" placeholder="Nhập hotline">
                        </div>
                        <div class="col-sm-12">

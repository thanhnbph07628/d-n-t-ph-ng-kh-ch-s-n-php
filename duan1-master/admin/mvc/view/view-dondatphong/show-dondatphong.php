    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="page-title">Show đơn đặt phòng</h4>
            </div>
                ...
                <div class="d-flex align-items-center justify-content-end">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Show đơn đặt phòng</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="col-12">
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="m-icon">
                            <a href="index.php?controller=dondatphong&action=dondatphonghoantat">
                                <h4 class="mdi mdi-feather" title="Thêm">Lịch sử đặt phòng</h4>
                            </a>
                        </div>
                                    ...
                                    foreach ($data as $key => $value) {
                                        ...
                                        <td><?php echo $value["BookRoomID"] ?></td>
                                            ...
                                            <?php
                                                ...
                                                // echo $link;
                                                ?>
                                            <td><a href="index.php?controller=dondatphong&action=xacnhan-dondatphong&id=<?php echo $value["BookRoomID"] ?><?php echo $link  ?>&page=<?php echo $page ?>"><button class="btn btn-success" name="luu">
                                                        <?php
                                                            switch ($value["Handling"]) {
                                                                case 0:
                                                                    echo "Duyệt đơn đặt phòng";
                                                                    break;
                                                                case 1:
                                                ...
                                                <?php
                                                    if ($value["Handling"] == 2) {
                                                        ?>
                                                    <a onclick='return confirm("Xác nhận trả phòng")' href="index.php?controller=dondatphong&action=tra-dondatphong&id=<?php echo $value["BookRoomID"] ?>&idroom=<?php echo $value["RoomID"] ?><?php echo $link ?>&page=<?php echo $page ?>"><button class="btn btn-primary" name="luu">Trả phòng</button>
                                                    <?php
                                                        } else if ($value["Handling"] == 0) {
                                                            ?>
                                                        <a onclick='return confirm("Xác nhận hủy phòng")' href="index.php?controller=dondatphong&action=huy-dondatphong&id=<?php echo $value["BookRoomID"] ?>&page=<?php echo $page ?>&dk=show-dondatphong "><button class="btn btn-danger" name="luu">Hủy phòng</button>
                                                        <?php
                                                            }
                                                            ?>
                                                            ...
                                                            <div class="row info-dondatphong">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <?php
                                                                        ...
                                                                        ?>
                                                                    <span class="clearfix">Khách hàng: <?php echo $value["Name"] ?></span><br>
                                                                    <span class="clearfix">Số điện thoại: <?php echo $value["Phone"] ?></span><br>

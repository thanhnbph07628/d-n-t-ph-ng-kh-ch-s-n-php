    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="page-title">Thêm thành phố</h4>
                <div class="m-icon">
                ...
                <div class="d-flex align-items-center justify-content-end">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href="">Thêm thành phố</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="card card-body">
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="text" name="nameCity" class="form-control" required placeholder="Nhập tên thành phố">
                        </div>
                        <div class="form-group">

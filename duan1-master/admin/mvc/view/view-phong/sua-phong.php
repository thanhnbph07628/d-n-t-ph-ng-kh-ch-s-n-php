                ...
                <div class="d-flex align-items-center justify-content-end">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href="">Sửa phòng</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="card card-body">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select class="custom-select col-12" name="khachsan" id="khachsan">
                                <?php
                        ...
                        <div class="form-group">
                            ...
                            <select name="loaiphong" class="custom-select col-12" id="loaiphong">
                                <?php
                                echo '<option value="' . $getRoomTypeID["RoomTypeID"] . '">' . $getRoomTypeID["NameRoomType"] . '</option>';
                                ?>
                            </select>
                        </div>
                        <div class="form-group">
                            <label>Tên phòng</label>
                            <input name="name_room" value="<?php echo $data['RoomName'] ?>" type="text" class="form-control" placeholder="Nhập tên phòng">
                        </div>
                        <img src="../mvc/Webroot/image/img_room/<?php echo $data['Images'] ?>" width="250px"><br><br>
                        <div class="form-group">
                            <label>Ảnh</label>
